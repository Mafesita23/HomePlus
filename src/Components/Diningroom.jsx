...
export default function Diningroom() {
    ...
    <div class="w-72 bg-white drop-shadow-md rounded-lg">
        ...
        <div class="px-5 py-3 space-y-2">
            ...
            <p class="space-x-2">
                <span class="text-2xl font-semibold">$850.000</span>
            </p>
            <div class="flex justify-between items-center pt-3 pb-2">
                <a href="#"
                    class="px-4 py-2 bg-red-600 hover:bg-amber-600 text-center text-sm text-white rounded duration-300">
    ...
    <div class="w-72 bg-white drop-shadow-md rounded-lg">
        ...
        <div class="px-5 py-3 space-y-2">
            ...
            <p class="space-x-2">
                <span class="text-2xl font-semibold">$750.000</span>
            </p>
            <div class="flex justify-between items-center pt-3 pb-2">
                <a href="#"
                    class="px-4 py-2 bg-red-600 hover:bg-amber-600 text-center text-sm text-white rounded duration-300">
    ...
    <div class="w-72 bg-white drop-shadow-md rounded-lg">
        ...
        <div class="px-5 py-3 space-y-2">
            ...
            <p class="space-x-2">
                <span class="text-2xl font-semibold">$1'750.000</span>
            </p>
            <div class="flex justify-between items-center pt-3 pb-2">
                <a href="#"
                    class="px-4 py-2 bg-red-600 hover:bg-amber-600 text-center text-sm text-white rounded duration-300">
    ...
    <div class="w-72 bg-white drop-shadow-md rounded-lg">
        ...
        <div class="px-5 py-3 space-y-2">
            ...
            <p class="space-x-2">
                <span class="text-2xl font-semibold">$1'000.000</span>
            </p>
            <div class="flex justify-between items-center pt-3 pb-2">
                <a href="#"
                    class="px-4 py-2 bg-red-600 hover:bg-amber-600 text-center text-sm text-white rounded duration-300">
